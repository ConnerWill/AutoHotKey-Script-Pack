...
*/
x32:=""
x64:=""
FileRead,Text,%A_LineFile%
Pos1:=RegExMatch(Text,"Om)(\x3B~ Do Not Change From Here\R)",Start)
Pos2:=RegExMatch(Text,"Om)(\x3B~ To.*)\R?",End)
RegExMatch(Text,"O)(x32:=.*)",Found32)
RegExMatch(Text,"O)(x64:=.*)",Found64)
Info:=SubStr(Text,Pos1,End.Pos(1)+End.Len(1)-Pos1)
SetBatchLines,-1
ListLines,Off
...
GI.AddCode:=RegExReplace(Info,"\x3B~ Do Not Remove This Line","static " Found32.1 "`r`n`tstatic " Found64.1)
return
GrabbieGuiEscape:
...
Class Grabbie{
	_Testing(){
		...
		*/
		...
		while(wb.ReadyState!=4)
			Sleep,10
		this.Doc:=wb.Doc,Y:=0
		this.TypeValue:={Mouse:["Type","Action","Actual","ClickCount","Wait","WindowWait","Comment","Match","OffX","OffY","Area","Bits","Ones","Zeros","Threshold","W","H"]
	...
	CapturePixels(){
		...
		while(Next:=TV_GetNext(Next,"F")){
			...
			for a,b in this.TypeValue[Obj.Type]{
				if(b="OffX"||b="OffY")
					...
					Row.=b ":" Value "," ;`n`t Tweaked per Jackie idea.  Perhaps make this an option instead of hard code
			}
		...
		this.SetObj({RestorePOS:this.GetChecked("RestorePOS")}) ;Trying to add this checkbox
	}Select(){
		MouseGetPos,,,,Control,2
		if(Control!=this.HWND.IE)
			return
